...
#### D. Manager sparse warm-start (2026-04-06 조정)
Manager-only stage는 학습 초반 **`20%`** episode 동안 sparse anchor target에 대한 CE 중심 warm-start를 수행합니다. (이전 `35%`에서 하향 조정)

*   `sparse_warmstart_ratio = 0.20`
