...
class Phase1GuidedWorkerTrainer(DOMOTrainer):
    """APTE phase1: training-time hidden guidance, inference-time flat worker."""
    ...
    def train(self, episodes):
        ...
        pbar = tqdm(range(episodes), desc="APTE-Phase1", dynamic_ncols=True)
        for ep in pbar:
